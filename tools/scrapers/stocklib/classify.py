...
NON_PLANT_KEYWORDS = frozenset({
    ...
    "dynamic lifter", "eco oil", "eco-oil", "ecofend", "eucalyptus", "fertiliser",
    ...
    "lemon scented gum", "lomandra", "melaleuca", "narrow-leaved ironbark",
    "neem oil", "orchard kit", "ornamental", "osmocote", "pest spray",
    "plant label", "poss-off", "postage", "potting mix", "powerfeed", "pruning",
    ...
    "soil mix", "spray", "stake", "support", "swamp paperbark", "swamp turpentine",
